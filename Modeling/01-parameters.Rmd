...
The variety of shapes of the nine pattern-book functions means that, often, one or another will be suitable for the modeling situation in hand. [Combining the functions to create a greater diversity of shapes is the subject of @sec-assembling.]{.aside}
...
2. Find numerical values for the parameters $A$, $B$, $a$, and $b$. In @sec-fitting-by-eye we will show you some ways to make this part of the task easier.

...
I don't know your cousin, but I suspect she will have an easy time answering (1) and (2) correctly. As for (3), she might give the correct answer, "5 miles," or just say "5." If so, you will follow up with "5 what?" at which point she'll respond, "miles."
...
10-year-olds are pretty creative, so I'm not sure how she'll answer (5). But if you ask your Ph.D. aunt, she'll answer along the lines of "silly question," or "there is no such thing." that is  true.
...
r"(Invalid. Exponentiation of a dimensionful quantity isn't allowed.)" = r"(Exponention is allowed, so long as the exponent is an integer (or if the operation results in an integer exponent))",
  ...
  r"(Invalid. I can't make any sense out of T$^4$ as a dimension.)" = r"(Get used to such things. What matters is whether the construction follows the rules. You will often encounter compound dimensions that seem crazy complicated. For instance, foot-pounds (L$^2$MT$^{-2}$) is a perfectly familiar unit to a mechanic.)",
  random_answer_order=TRUE
)
```

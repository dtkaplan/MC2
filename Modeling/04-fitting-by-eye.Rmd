...
This chapter is about ***fitting***, finding parameters that will align the functions with the data such as in @fig-stans-data. In this chapter,  we will work the the exponential, sinusoid, and gaussian functions. In Chapter @sec-magnitude we will consider the power-law and logarithm functions.

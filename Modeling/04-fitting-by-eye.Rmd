...
The Gaussian has two parameters: the "mean" and the "sd" (short for standard deviation). It's straightforward to estimate values of the parameters from a graph, as in @fig-gauss-param-estimates. 

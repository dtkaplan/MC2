...
Possibly you already understand what is meant by "an additional square foot" or "an extra bathroom." These ideas can be intuitive, but they can be best understood with a grounding in calculus, which we turn to in Block @sec-differentiation-block. For instance, the negative scalar on `bedrooms` will make sense when you understand "partial derivatives," the subject of Chapter @sec-partial-change.

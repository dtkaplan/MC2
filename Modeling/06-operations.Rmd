...
We can't readily graph functions with three or more inputs. So zero finding or optimization with such functions requires other methods. The calculus concepts and tools we will study in Block @sec-differentiation-part will provide the basis for these methods. 

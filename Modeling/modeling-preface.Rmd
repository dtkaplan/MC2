...
(sometimes called the inverse square law), which relates the mass of two objects ($m_1$ and $m_2$), and the distance between them to the force of gravitation. We'll get to the purpose of the $G$ in @sec-dimensions, but for the moment, understand that this process of translating observations about planetary motion into a mathematical form is characteristic of the first stage of the modeling process.

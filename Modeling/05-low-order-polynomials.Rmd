...
Newton's law of cooling from last chapter, Hooke's law 
...
#| out-width: "40%"
#| fig-cap: "The ***eight simple shapes***, locally, of functions with one input. (See Chapter \\@ref(local-approximations).)"

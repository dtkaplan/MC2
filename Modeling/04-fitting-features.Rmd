...
By the way, the fitted exponential function is far from a perfect match to the data. We will return to this mismatch in @sec-modeling-cycle when we explore the ***modeling cycle***.
...
An example of such automated fitting is given in @lst-first-two-layers. We will return to the topic in more depth in @sec-modeling-cycle.

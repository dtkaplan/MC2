...
askMC(
  ...
  "`slice_plot(dnorm(x,64.5,2.5)~x, domain(x=0:64.5)`" = "The graphics domain has been set too narrowly to display the whole gaussian.",
  "+`slice_plot(dnorm(x,64.5,2.5)~x, domain(x=50:80)`+",
  "`slice_plot(pnorm(x,64.5, 2.5)~x, domain(x=0:64.5))`" = "This plots a sigmoid, not a gaussian.",

...
knitr::include_graphics(normalizePath("www/800px-Mt_Eden_Panorama_December_2012.jpg"))
```
...
```{r Maungawhau-plot, echo=FALSE, fig-cap: "A combination surface and contour plot of the topography of Maungawhau.", warning=FALSE, message=FALSE}
if (knitr::is_latex_output()) {
  knitr::include_graphics(normalizePath("www/volcano-multi-view.png"))
} else {
library(plotly)

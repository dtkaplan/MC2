...
`r insert_calcZ_exercise("XX.XX", "Vc6fl7", "/Users/kaplan/MC2/Modeling/Exercises/kitten-find-linen.Rmd")`

Watch this movie showing the growth of a colony of *E. coli*. Each rod is one bacterium.

```{asis eval=knitr::is_html_output()}
![Growth of E. coli](www/E-coli-colony-growth.gif)
```

```{asis eval=knitr::is_latex_output()}
Link to movie: <https://dtkaplan.github.io/MC2/Modeling/www/E-coli-colony-growth.gif>
```

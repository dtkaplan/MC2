...
askMC(
  prompt = "Assume that 25% of the alcohol remains after 1 hour? If the process were exponential, how much would remain after 2 hours?",
    "10%" = "That's  what the study is reported to have found, but that is  not consistent with an exponential process that decays to 25% after one hour",
...
askMC(
  prompt = "What is the half-life of an exponential process that decays to 25% after one hour?",
...
askMC(
  prompt = "Use `amount.left()` as defined in the scaffolding to guess-and-check how many halvings it takes to bring something down to 10% of the original amount.",
...
askMC(
  prompt = "How much is left after 1 hour and after 2 hours for a half life of 33 minutes?",
    "+28% and  8%+",
    "31% and 4%",
    "30% and 9%",
    "27% and 9%"

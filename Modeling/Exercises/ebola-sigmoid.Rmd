...
*Put aside for the moment that the Ebola data plotted in Figure \@ref(fig:ebola-data) does not look exactly like the standard sigmoid function. Follow the fitting procedure as best you can.*
...
askMC(
  prompt = "Where is the centerline?",
    "+Near Day 200+" = "",
    "Near Day 300" = "that is  the center of the vertical scale, not the day at which the curve reaches half-way to the eventual plateau.",
    "At about 7000 cases" = "that is  half-way up to the plateau, but the answer you  want is the day at which the curve reaches that point."
)
```

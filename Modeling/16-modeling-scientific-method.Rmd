...
In @sec-polishing-promise, we referred to a way to improve parameters in order to better match patterns in data: polishing. Polishing can be carried out by software such as `fitModel()`. It is usually worthwhile because it is easy and mostly automatic. 

...
We are going to start to construct a simple theory of ocean tides. Let's start with some data, several days' tides in Providence, Rhode Island in 2010. The tide `level` is in meters.

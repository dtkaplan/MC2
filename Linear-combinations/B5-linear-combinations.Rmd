...
#| label: fig-two-vecs
#| out-width: "50%"
#| fig-cap: "Two vectors $\\color{blue}{\\vec{u}}$ and $\\color{magenta}{\\vec{v}}$ embedded in 3-dimensional space. The subspace spanned by an individual vector is shown as a line. Go to <https://dtkaplan.github.io/MC2/Linear-combinations/B5-linear-combinations.html#fig-two-vecs>" for an interactive, rotatable version."
...
#| label: fig-two-vecs-planes
#| out-width: "50%"
#| fig-cap: "Two vectors $\\vec{u}$ and $\\vec{w}$. The subspace spanned by two vectors is a plane, shown here as a gray surface. Go to <https://dtkaplan.github.io/MC2/Linear-combinations/B5-linear-combinations.html#fig-two-vecs-planes> for an interactive version."
knitr::include_graphics("www/two-vecs-planes.png")
```

...
Here are twelve labeled vectors, A through M. There is a thirteenth vector, labeled "Null vector." that is  a vector of length zero, so it can't be drawn as an arrow. Note that the direction of the null vector does not matter, since the vector length is zero. 

...
In this exercise, you are going to *check* proposed solutions to the target problem. Each question poses one target problem. One of the answers is correct. Use R in a `r sandbox_link()` to select the correct answer.

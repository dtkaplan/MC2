...
By convention, when we write a vector as a set of coordinate numbers, we write the numbers in a ***column***. For instance, the vector in Figure \@ref(fig:vector-graph-paper), which we will call $\vec{green}$,  is written numerically as:

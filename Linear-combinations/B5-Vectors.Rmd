...
A ***zero correlation*** indicates no simple (linear) relationship between the two variables. Zero correlation occurs when the variables are **orthogonal**, a term described in [Section @sec-orthogonality].

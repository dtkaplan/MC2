...
It is hard to form an image of the motion from these graphs. Better to show the $x-$ and $y-$ components of position in a single frame, as in Figure \@ref(fig:velocity-vs-position)

...
set.seed(101)
draw_pipe(time=1, sigma = 1.7, dom=bounds(x=c(-25, 25)), n=1000)
set.seed(102)
draw_pipe(time=10, sigma = 4.5, dom=bounds(x=c(-25, 25)), n=1000)
set.seed(103)
draw_pipe(time=20, sigma = 6.4, dom=bounds(x=c(-25, 25)), n=1000)
set.seed(104)
draw_pipe(time=40, sigma = 9.0, dom=bounds(x=c(-25, 25)), n=1000)
```

...
@fig-cow-consumption shows a model of a cow's consumption of vegetation as a sigmoidal function of the amount of vegetation. In addition to the mathematics of the function, it is helpful to be able to translate the shape of the function into terms that make sense in the **context** of the model.

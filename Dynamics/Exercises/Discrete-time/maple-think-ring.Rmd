...
We are going to use the auto-regressive format to examine an *ansatz* to the AB10 discrete-time system. Recall the one-dimensional linear system with a fixed point at $x_n=0$. This had a simple solution: 

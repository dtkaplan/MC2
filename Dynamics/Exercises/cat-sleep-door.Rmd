...
Section @sec-ballistics gives the equations for the motion of a cannonball with a simple model of air resistance and shows how to integrate them numerically with `integrateODE()`.

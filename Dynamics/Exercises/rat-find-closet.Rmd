...
vectorfield_plot(f(u,v) ~ u & v, g(u,v) ~ u & v, 
                 domain(u=-0:3, v=-2:1), transform=function(x) x^0.25) %>%
...
```{rfc98-2A, echo=FALSE, results="markup"}
askMC("Which direction for trajectory A?",
      "N", "NE", "E", "SE", "S", "+SW+", "W", "NW")
```

```{rfc98-2B, echo=FALSE, results="markup"}
askMC("Which direction for trajectory B?",
      "N", "NE", "E", "SE", "S", "+SW+", "W", "NW")
```

```{rfc98-2C, echo=FALSE, results="markup"}
askMC("Which direction for trajectory C?",
      "N", "+NE+", "E", "SE", "S", "SW", "W", "NW")
```

```{rfc98-2D, echo=FALSE, results="markup"}

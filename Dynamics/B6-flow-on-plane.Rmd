...
contour_plot(-sin(theta) ~ theta & v, contours_at=0, contour_color="blue", bounds(theta=-3:3, v=-2.5:2.5), labels=FALSE) %>%
  contour_plot(v ~ theta & v, contours_at=0, contour_color="red", labels=FALSE) %>%
vectorfield_plot(v ~ theta & v, -sin(theta) ~ theta & v, bounds(theta=-3:3, v=-2.5:2.5)) %>%

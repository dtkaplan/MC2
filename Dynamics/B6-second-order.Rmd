...
#| fig-cap: "Adding air resistance to the model changes the trajectory. For reference, the trajectory *without air resistance* is plotted in $\\color{orange}{\\text{orange}}$."
P1 <- 
  gf_hline(yintercept=~0, color="brown") %>%

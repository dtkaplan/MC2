...
Given a choice between a numerical and a symbolic solution to ***the same problem***, the symbolic solution is generally better: it's exact and it can incorporate parameters symbolically.

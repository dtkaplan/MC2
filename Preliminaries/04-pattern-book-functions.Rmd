...
#| column: margin
#| fig-cap: "The exponential function is exactly the same as the logarithm but---and this is a big but---reversing the roles of the input and output. Visually, that reversal of roles amounts to flipping the graph." 
...
::: {.column-margin}
$$\mathbf{(v)}\ \ \ \ \ \ln(\exp(x)) = x$$and conversely  $$\exp(\ln(x)) = x\ .$$
:::
...
SUPPRESSING THE EXERCISES FOR NOW.

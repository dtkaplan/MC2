...
```{r monomial-graphs, echo=FALSE, warning=FALSE} 
#| label: fig-monomial-graphs
#| fig-cap: "Graphs of the monomial functions from order 0 to 5. The dashed $\\color{magenta}{\\text{magenta}}$ line marks zero output."
#| out-height: "50%"

...
- the input is the altitude on your hike up [Pikes Peak](https://en.wikipedia.org/wiki/Pikes_Peak); the output the air temperature. Typically, as you gain altitude the temperature goes down. 

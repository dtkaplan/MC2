...
::: {.column-margin}
[Chapter -@sec-dimensions-and-units] is entirely dedicated to the topic of dimensions. This is a preview.
:::
...
- the input is the altitude on your hike up [Pikes Peak](https://en.wikipedia.org/wiki/Pikes_Peak) and the output the air temperature. Typically, as you gain altitude the temperature goes down. 
...
::: {#sec-fig-pathways layout-ncol=2}

![Discrete](www/stepping-stones.png {#sec-fig-stepping-stone}

![Continuous](www/walkway.png {#sec-fig-walkway}

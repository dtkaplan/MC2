...
This chapter introduces several features of functions. These features include:
...
By the end of the chapter @describing-functions, you should be able to list all the basic pattern-book functions and describe the features relevant to each.

...
askMC(
  prompt = "Which of these stories is consistent with the relationship between a gaussian and its corresponding sigmoid?",
    ...
    "The gaussian is the amount of water in the bathtub while the sigmoid is the rate at which water flows from the tap." = "You turn the tap on and off after a while. That's not what the sigmoid looks like.",

...
askMC(
  prompt = "Which of the functions in @fig-M3-12-01 is **concave up** over the domain shown in the graph?",
r"(+A+)" = r"( )",
...
askMC(
  prompt = r"(Which of these functions in @fig-M3-14-01 has a **vertical** asymptote? )",
  "+A+" = r"( )",
...
askMC(
  prompt = r"(Which of the functions in @fig-M3-14-04b has a **vertical** asymptote? )",
  "+A+" = r"( )",
...
askMC(
  prompt = r"(For the function in @fig-M3-14-06, where is the **vertical** asymptote located? )",
r"(At $x=0$)" = r"( )",
  r"(+At $x=1$+)" = r"( )",
...
askMC(
  prompt = r"(For the function in @fig-M3-14-06, where is the **horizontal** asymptote located? )",
...
askMC(
  prompt = r"(Does the function in @fig-M3-12-03 have an **inflection point**?)",
...
askMC(
  prompt = r"(Does the function in @fig-M3-14-04 have an **inflection point**?)",
...
askMC(
  prompt = r"(Which of these is a correct description of a horizontal asymptote in the function in @fig-M3-14-07?)",

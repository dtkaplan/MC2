...
We can't readily plot out this function because there are three inputs and one output, and it is unnatural to draw a 4-dimensional space. But we can draw a **slice** through the 4-dimensional space.

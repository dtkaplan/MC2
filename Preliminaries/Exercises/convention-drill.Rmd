...
askMC(
  "What is $h()$?", 
  "+The name of a function+" = "Right. Typically we use $f()$, $g()$, $h()$ or something similarly generic to stand for a function that we are going to be working with for a little while. Think of these as pronouns. Just as we can say, meaningfully, \"She gave it to him,\" we can say $h(x) \\equiv f(x) + g(2*x)$",

...
We will show you the answers for the exponential and sinusoid functions. You will have to modify the computer command to graph the other pattern-book functions.

...
There can be multiple ways of forming coordinates for the same space. In terms of the mechanism for the robotic hand, it's configuration can be specified by the six degrees of freedom enumerated in @tbl-six-degrees. But from the point of view of a person training the robot, it might be more convenient to think about the configuration in terms of the six quantities given in @tbl-six-degrees-2. 

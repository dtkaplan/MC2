...
::: {.callout-tip}
@sec-spaces-intro introduces the idea of "spaces." A function ***maps*** each point in the function's input space into a single point in the function's output space.  The input and output spaces are also known respectively as the "domain" and "range" of the function.
:::

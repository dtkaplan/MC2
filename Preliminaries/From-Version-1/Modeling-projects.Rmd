...
The R function `cumsum()` calculates the cumulative sum on a column of data. You are going to need to do a little data wrangling; we cannot do it for you because we don't know what model you decided to settle on.

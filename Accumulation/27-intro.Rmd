...
Professional demographers make much more sophisticated models using detailed data from many sources. The demographers at the US Census Bureau predict that the population will reach a maximum of 404 million in 2060, shown by the little blue dot in @fig-pop-prediction-bad.  That's not too different from what we got by analyzing just the raw census numbers. 
:::

...
We've written the differential of the relationship because we are going to substitute for $t$ and $dt$ to translate the integral to be solely in terms of $\theta$:

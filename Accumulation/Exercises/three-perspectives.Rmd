...
When you reach the point where you can say, "that is  obvious," and can write down the three items from memory, you will have achieved an important facility with calculus.

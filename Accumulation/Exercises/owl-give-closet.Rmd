...
askMC(
  ...
  "+$df = -\\frac{\\sin(\\ln(t))}{t} dt$+" = "Since the chain rule tells us $\\partial_t\\cos(\\ln(t)) = -\\sin(\\ln(t))/x$.",
    "$du = -\\frac{\\sin(\\ln(t))}{t} dt$" = "There's no $u$ in sight in this problem. It's $f$.",
    "$dv = -\\frac{\\sin(\\ln(t))}{t} dt$" = "There's no $v$ being used in this problem. It's $f$ that we're asking about.",

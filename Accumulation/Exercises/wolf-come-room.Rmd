...
We are going to focus on Chapter 4, "Elementary Functions," and indeed just a few sections from that chapter. (A better name for the chapter would be "The Functions Most Often Used." They are not "elementary" as in "elementary school" but as in the "periodic table of elements.") 

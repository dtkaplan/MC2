...
Almost every computer language provides something like `function`. The internal workings of `function` are elaborate and detailed ... only advanced programmers need to be aware of them. This, in much the same way as it's unnecessary to understand the workings of a transistor to use a computer, or comprehend the biochemistry of a COVID vaccine to benefit from it. 

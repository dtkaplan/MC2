...
Without calculus and the ideas of functions and their derivatives, Smith was not able to think about prices in a modern way where price is shaped by demand and supply. Instead, for Smith, there is a "natural price": a fixed quantity. Smith lived near the end of a centuries-long period of ***static*** economies. Transportation, agriculture, manufacture, population were all much as they had been for the past 500 years or longer. 
...
Exercise??? Define the derivative of a piecewise function by putting together the derivatives of the pieces.



## Finite difference derivatives

${\cal D}_t$ is the "Finite-difference derivative" 

...
Anyone familiar with the squares of the integers can see the pattern in 1, 4, 9, 16, .... To demonstrate the pattern even more clearly, Galileo took the difference between the successive positions, what we will call the "first increment." 

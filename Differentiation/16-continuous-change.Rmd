...
Strictly speaking, for functions with just one input the subscript on ${\cal D}$ isn't needed. Even so, we'll always include a subscript, if only for the sake of forming good habits to serve us when we do examine rates of change in functions of multiple inputs.

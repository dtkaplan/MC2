...
Galileo had neither the mathematics nor the equipment to measure motion continuously in time. What is evident to us now---position is a function of time, which we denote $x(t)$---would have had little practical significance to him. But we discover in his first increments of $x$ something much like the ***slope function*** in Chapter @sec-fun-slopes. 

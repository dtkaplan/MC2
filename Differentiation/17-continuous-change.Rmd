...
We've introduced a bit of new notation in the previous section, ${\cal D}_t$. As mentioned previously, ${\cal D}$ stands for "the rate of change of ____ with respect to _____." In use, you put a function in the first slot indicated by ____ and the name of an input variable in the second slot. Which function and variable depends on what you want to describe. For instance, the position of a rolling ball is a function of time:  $x(t)$. "The rate of change of $x(t)$" is written ${\cal D}_t x(t)$. This object ${\cal D}_t x(t)$ is itself a function of time. 

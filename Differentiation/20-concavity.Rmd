...
There are other aspects of functions, introduced in Section @sec-concavity-intro, that are also readily discerned from a glance at the function graph. 
...
As you see from  Section @sec-concavity-deriv, it is easy to quantify the concavity of a function $f(x)$: just evaluate the second derivative $\partial_{xx} f(x)$. However, it turns out that people cannot do a good job of estimating the quantitative value of concavity by eye.

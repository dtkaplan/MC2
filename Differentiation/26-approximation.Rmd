...
Four of the ***eight simple shapes*** correspond to the sides of the parabola. The labels refer to the graphs in @fig-eight-simple-shapes2.
:::
...
As discussed in @sec-low-order-two, there are generic names for the various terms: **linear**, **quadratic**, **interaction term**, and **constant term**. 

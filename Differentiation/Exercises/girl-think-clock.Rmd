...
c. If setting $h=0$ cannot cause a division by zero, it is legitimate to do so. Set $h=0$ and simplify the expression $- \frac{1}{x^2 + hx}$. Compare this to the rule for $\partial_x \frac{1}{x}$ given in Section @sec-d-pattern-book.

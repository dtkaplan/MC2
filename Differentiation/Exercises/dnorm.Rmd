...
to construct the plot, you'll have to pick specific values for $mn$ and $sd$. Make sure that you use the same $sd$ and $mn$ when constructing $f_1()$ and $f_2()$. For instance:

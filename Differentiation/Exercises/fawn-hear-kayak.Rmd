...
We're all busy people these days and nobody has the time to compute an infinite number of coefficients to program the polynomial computer. So, we'll have to use just a few coefficients. How many is enough?

...
askMC(
  ...
  "All the points inside the 9.5 contour are at the same height." = "The function $C(w,d)$ is infinitely differentiable so it's not possible to make a sudden shift from a sloped form to one that is dead flat."
)
```

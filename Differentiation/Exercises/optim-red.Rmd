...
The road and the lion are graphed in the sandbox for the road $f(x) \equiv x^2 e^{-x}$. You can see that the road comes closest to the lion at roughly $x=3$. When you implement the lion.dist$(x)$ function, you will be able to find the *argmin*, that is, the value of the input $x$ for which the output lion_dist$(x)$ is minimal. The value of the function lion_dist$(x)$ at the argmin is the *min* of the function.

...
Consider the model presented in Section @sec-low-order-two about the energy expenditure while walking distance $d$ on a grade $g$: $$E(d,g) = (a_0 + a_1 g)d$$ where $d$ is the (horizontal equivalent) of the distance walked and $g$ is the grade of the slope (that is, rise over run). 

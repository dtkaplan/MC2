...
Consider the model presented in @sec-low-order-two about energy expenditure walking distance $d$ on a grade $g$: $$E(d,g) = (a_0 + a_1 g)d$$ where $d$ is the (horizontal equivalent) of the distance walked and $g$ is the grade of the slope (that is, rise over run). 

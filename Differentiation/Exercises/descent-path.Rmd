...
to treat alt() as a function of time, we need to write "distance from the runway" as a function of time. Let's set $t=0$ to be the time when the plane begins its descent, when it's 30,000 feet from the end of the runway. Distance from the runway will be $$x(t) = 30000 - v\, t$$ where $v$ is the plane's velocity.

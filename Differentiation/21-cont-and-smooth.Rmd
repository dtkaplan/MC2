...
In this chapter, we'll elaborate on ***continuity***, one of the ideas introduced in Section @sec-word-descriptions, and use the concept of continuity to characterize functions in a new way: their ***smoothness***. 

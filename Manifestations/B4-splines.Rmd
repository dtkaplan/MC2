...
TAB <- if (knitr::is_html_output()) {
  Znotes::and_so_on(Zcalc::Robot.stations)
} else {
  Znotes::and_so_on_latex(Zcalc::Robot.stations)
}
TAB %>% 

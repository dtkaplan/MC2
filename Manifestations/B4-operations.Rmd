...
xstar <- Zeros(f(x) - 10 ~ x, bounds(x=-3:3))$x
slice_plot(f(x) ~ x, bounds(x=-2:5), color="brown", label_text="f(x)", label_vjust=-0.5) %>%
...
`r insert_exercises("Manifestations", "operations")`

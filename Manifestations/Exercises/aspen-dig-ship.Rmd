...
askMC(
  ...
  "5.5" = "that is  $x_1$.",
  "3.659091" = "that is  $x_2$.",
  "3.141593" = "that is  $\\pi$, which incidentally is $\\neq \\sqrt{10}$.",
  "3.196005" = "that is  $x_3$.",
  "3.162456" = "that is  $x_4$.",
  "3.162354",
  "+3.162278+",
...
askMC(
  ...
  "After 3 steps we get 4.713." = "that is  about 6% away from the true number.",
  "After 3 steps we get 4.472." = "that is  not the right answer for $x_3$.",
  "After 4 steps we get 4.472." = "that is  not the right answer for $x_4$.",

...
3. Consider the velocity $\partial_t x(t)$ of the pen. (We're thinking of the $x$- direction only. The pen will also have a $y$-component of velocity.)
    ...
    b. Imagine that the pen moved with constant initial velocity $\partial_t x(t=0)$. (It doesn't, but imagine that it does.) At what value of $t$, if any, will the pen reach the $x$-value $x_2$?

...
There can be many ways to describe a given path using $x(t)$ and $y(t)$ functions. Your task in this problem is to construct a few such paths connecting points 10 and 11 in @fig-robot-points.

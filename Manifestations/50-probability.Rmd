...
:::
::: {.callout-note}
## @thm-jar-of-money How much money is in the jar?
...
Comparing the contest entries by normalizing each of them to a probability density function.
:::
...
@sec-center-of-mass uses this same form of integral for computing the ***center of mass*** of an object.
...
```{webr-r}
Integrate((x-6.3)^2 * 
  dnorm(x, mean=6.3, sd=17.5) ~ x, domain(x=-Inf:Inf))
```
...
The contest entries shown in @fig-contest-compare.
:::
...
Three different opinions about the risk of a disease.
:::
